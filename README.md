...
* [herdr](https://github.com/ogulcancelik/herdr) ⭐ 30,517 | 🐛 201 | 🌐 Rust | 📅 2026-08-19 - Agent-aware multiplexer with persistent workspaces, tabs, panes, and status detection for CLI coding agents.
* [cmux](https://github.com/manaflow-ai/cmux) ⭐ 26,227 | 🐛 4,382 | 🌐 Swift | 📅 2026-08-19 - Ghostty-based macOS terminal with vertical tabs and per-agent notifications, built for keeping many concurrent sessions legible.
* [claude-squad](https://github.com/smtg-ai/claude-squad) ⭐ 8,338 | 🐛 55 | 🌐 Go | 📅 2026-07-30 - Runs each agent as a detached background session with its own worktree, so work continues after you close the pane. Claude Code, Codex, OpenCode, Amp.
* [agent-of-empires](https://github.com/agent-of-empires/agent-of-empires) ⭐ 3,100 | 🐛 134 | 🌐 Rust | 📅 2026-08-19 - Pairs a TUI with a matching web view, so the same sessions stay reachable from a phone. Claude Code, Codex, OpenCode, Gemini, Mistral Vibe.
...
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 752 | 🐛 48 | 🌐 Go | 📅 2026-08-17 - One TUI covering sessions across Claude Code, Codex, Gemini, and OpenCode, with live status and resume for each.
...
* [agterm](https://github.com/umputun/agterm) ⭐ 480 | 🐛 7 | 🌐 Swift | 📅 2026-08-18 - Native macOS terminal with named workspaces, a live dashboard, attention states, and a scriptable control API.
...
* [agent-manager](https://github.com/YoanWai/agent-manager) ⭐ 337 | 🐛 22 | 🌐 Go | 📅 2026-08-19 - tmux TUI with live status, a prompt that lands in the pane without attaching, and in-terminal diff review that sends line comments back to the agent. Claude Code, Codex, OpenCode, Grok, Gemini CLI, Pi, Hermes.
...
* [openkanban](https://github.com/TechDufus/openkanban) ⭐ 139 | 🐛 6 | 🌐 Go | 📅 2026-06-12 - Kanban board for orchestrating coding agents, rendered entirely in the terminal.
* [thurbox](https://github.com/Thurbeen/thurbox) ⭐ 46 | 🐛 6 | 🌐 Rust | 📅 2026-08-19 - TUI orchestrator with remote SSH sessions, inter-session messaging, and a native code-review view. Works with any CLI agent you define.
...
* [repomon](https://github.com/AliHamzaAzam/repomon) ⭐ 14 | 🐛 5 | 🌐 Rust | 📅 2026-08-18 - Rust TUI that supervises a fleet across many repositories at once, in durable tmux sessions you can approve from your phone.
...
* [Orca](https://github.com/stablyai/orca) ⭐ 48,759 | 🐛 4,163 | 🌐 TypeScript | 📅 2026-08-19 - Agentic development environment for running a fleet on your own subscription, available on desktop and mobile.
* [t3code](https://github.com/pingdotgg/t3code) ⭐ 19,457 | 🐛 1,607 | 🌐 TypeScript | 📅 2026-08-19 - Harness control surface available as web, mobile, and desktop app. Claude Code, Codex, Cursor, Grok Build, OpenCode.
* [Aperant](https://github.com/AndyMik90/Aperant) ⭐ 14,535 | 🐛 74 | 🌐 TypeScript | 📅 2026-06-14 - Runs up to 12 agent terminals with a self-validating QA loop and automatic conflict resolution when merging back to main.
* [qm](https://github.com/yc-software/qm) ⭐ 13,924 | 🐛 272 | 🌐 TypeScript | 📅 2026-08-19 - Multiplayer harness where each teammate gets an isolated workspace to run agents independently, driven from Slack or the web.
* [superset](https://github.com/superset-sh/superset) ⭐ 13,075 | 🐛 584 | 🌐 TypeScript | 📅 2026-08-19 - Code editor built around running many agents on your machine at once.
...
* [agent-orchestrator](https://github.com/Untrivial-ai/agent-orchestrator) ⭐ 9,633 | 🐛 711 | 🌐 Go | 📅 2026-08-19 - Agent IDE for fleets that plans the work, spawns the agents, then fixes CI failures and merge conflicts without being asked.
* [OpenChamber](https://github.com/openchamber/openchamber) ⭐ 8,965 | 🐛 889 | 🌐 TypeScript | 📅 2026-08-19 - Open-source workspace for running, supervising, and reviewing AI coding work across desktop, browser, editor, and mobile, with parallel model runs and per-run worktrees.
* [Emdash](https://github.com/generalaction/emdash) ⭐ 5,443 | 🐛 206 | 🌐 TypeScript | 📅 2026-08-18 - Agentic development environment running parallel agents against any model provider.
...
* [collaborator](https://github.com/collabs-inc/collab-public) ⭐ 2,911 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-08 - Arranges terminals, editors, and files as tiles on an infinite pan-and-zoom canvas instead of tabs.
...
* [bb](https://github.com/get-bb/bb) ⭐ 2,354 | 🐛 238 | 🌐 TypeScript | 📅 2026-08-19 - Self-controlling agentic IDE that orchestrates multiple coding agents in live threads you can follow, steer, or hand off, driven from a desktop app, web app, CLI, or HTTP API.
* [supacode](https://github.com/supabitapp/supacode) ⭐ 2,281 | 🐛 57 | 🌐 Swift | 📅 2026-08-13 - Native macOS command center for worktree-per-agent development.
* [mux](https://github.com/coder/mux) ⭐ 1,977 | 🐛 269 | 🌐 TypeScript | 📅 2026-08-19 - Desktop app for isolated, parallel agentic development.
* [synara](https://github.com/Emanuele-web04/synara) ⭐ 1,567 | 🐛 189 | 🌐 TypeScript | 📅 2026-08-18 - GUI desktop workspace for running and managing agents across local projects.
* [nimbalyst](https://github.com/nimbalyst/nimbalyst) ⭐ 1,517 | 🐛 546 | 🌐 TypeScript | 📅 2026-08-19 - Visual workspace pairing parallel worktree sessions with kanban and direct visual editing. Claude Code, Codex, OpenCode.
* [Traycer](https://github.com/traycerai/traycer) ⭐ 1,201 | 🐛 143 | 🌐 TypeScript | 📅 2026-08-19 - Bring-your-own-agent workspace running many sessions in parallel with context shared across models and providers, plus agent-to-agent messaging, shareable boards, and cross-device sync.
* [jean](https://github.com/coollabsio/jean) ⭐ 1,186 | 🐛 124 | 🌐 TypeScript | 📅 2026-08-19 - Desktop and web app for orchestrating agents across multiple projects and their git worktrees. Claude, Codex, OpenCode.
...
* [Waku](https://github.com/egoist/waku) ⭐ 1,025 | 🐛 85 | 🌐 Rust | 📅 2026-08-18 - Native macOS desktop app for working with local coding agents, keeping projects, sessions, and transcripts on your machine. Supports Amp, Claude Code, Codex CLI, Cursor CLI, Grok Build, OpenCode, and Pi.
* [Comet](https://github.com/zeronsh/comet) ⭐ 1,009 | 🐛 67 | 🌐 Rust | 📅 2026-08-19 - Cross-device control plane for coding agents, syncing sessions across machines and keeping agents running on an always-on daemon. Claude Code, Codex, Cursor, Grok, Hermes, Pi.
* [parallel-code](https://github.com/johannesjo/parallel-code) ⭐ 980 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-18 - Desktop app running Claude Code, Codex, and Gemini CLI side by side in isolated worktrees, with a built-in diff viewer and one-click merge.
...
* [ai-maestro](https://github.com/23blocks-OS/ai-maestro) ⭐ 749 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-19 - Dashboard spanning multiple machines, adding memory search, code-graph queries, and agent-to-agent messaging. Claude, Aider, Cursor.
* [kandev](https://github.com/kdlbs/kandev) ⭐ 663 | 🐛 63 | 🌐 Go | 📅 2026-08-19 - Kanban workbench whose multi-step workflows assign a different agent per step behind human gates, running locally, in Docker, over SSH, or in cloud executors.
* [Alethe](https://github.com/Kc1t/alethe-agents) ⭐ 358 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-18 - Local-first desktop workspace where agents and shells run as real PTYs in split panes and custom grids across projects, surviving pane close and app restart. Suspend idle groups to reclaim memory and resume with scrollback intact. Claude Code, Codex, OpenCode.
...
* [Proliferate](https://github.com/proliferate-ai/proliferate) ⭐ 172 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-19 - Agent IDE that runs sessions locally or in the cloud and lets you build reusable workflows from them.
...
* [Tempest](https://github.com/tempestai-dev/tempest) ⭐ 125 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-18 - Tauri desktop ADE running CLI agents in parallel isolated worktrees, with a shared local code-knowledge graph that cuts token use across sessions, plus live status and built-in diff/PR review.
...
* [Garcon](https://github.com/cfal/garcon) ⭐ 57 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-19 - Self-hosted browser and mobile workspace with diff review, Git/PR workflows, mobile approvals, scheduling, and cross-agent transfers. Seven CLI agents.
...
* [GraphCode](https://github.com/scgopi/GraphCode) ⭐ 44 | 🐛 6 | 🌐 Swift | 📅 2026-08-18 - macOS app that wires agent sessions into a graph: each node is a live terminal you can attach to mid-run, each edge a hand-off, message, or spawn that fires while you're away. Claude Code, Copilot CLI, Codex.
...
* [octomux](https://github.com/ShreyPaharia/octomux) ⭐ 21 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19 - Local dashboard with a kanban fleet view, one unified permission inbox across agents, and in-app diff review.
...
* [paperclip](https://github.com/paperclipai/paperclip) ⭐ 78,846 | 🐛 5,161 | 🌐 TypeScript | 📅 2026-08-19 - Self-hosted platform where agents wake on heartbeats to claim tickets, governed by org charts, budgets, and approval gates.
* [ruflo](https://github.com/ruvnet/ruflo) ⭐ 68,279 | 🐛 845 | 🌐 TypeScript | 📅 2026-08-19 - Meta-harness for deploying coordinated swarms and conversational multi-agent workflows. Formerly claude-flow.
* [buzz](https://github.com/block/buzz) ⭐ 28,524 | 🐛 2,874 | 🌐 Rust | 📅 2026-08-19 - Agents are first-class members of shared channels on a Nostr relay you own, with their own keys and audit trails. Claude Code, Codex, Goose.
* [gastown](https://github.com/gastownhall/gastown) ⭐ 17,668 | 🐛 396 | 🌐 Go | 📅 2026-08-19 - Scales to 20-30 agents with a coordinator, git-backed issue tracking, health watchdogs, and a Bors-style merge queue.
* [ClawTeam](https://github.com/HKUDS/ClawTeam) ⭐ 5,502 | 🐛 37 | 🌐 Python | 📅 2026-05-09 - Agents spawn and manage their own teammates from one command, coordinating through file-based or P2P inboxes across tmux worktrees.
* [claude\_codex\_bridge](https://github.com/SeemSeam/claude_codex_bridge) ⭐ 3,427 | 🐛 100 | 🌐 Python | 📅 2026-08-18 - Workspace for mixing different vendors' CLI agents in one visible collaboration session.
...
* [Agent Teams](https://github.com/777genius/agent-teams-ai) ⭐ 1,947 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-17 - Desktop app where you give high-level commands to autonomous coding-agent teams across Claude Code, Codex, OpenCode, Cursor, Grok, GitHub Copilot, Kiro, Z.AI, MiniMax, Kimi, 200+ models, and 75+ LLM providers. Agents coordinate through inter-agent messaging, Kanban tasks, and built-in code review.
* [scion](https://github.com/GoogleCloudPlatform/scion) ⭐ 1,676 | 🐛 50 | 🌐 Go | 📅 2026-08-18 - Orchestration testbed running agents in parallel isolated containers with dynamic coordination and normalized telemetry.
...
* [Orkas](https://github.com/Orkas-AI/Orkas) ⭐ 1,341 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-16 - A commander agent decomposes goals and dispatches specialists with isolated skills and memory. Claude Code, Codex, OpenCode, Cline.
* [Fusion](https://github.com/Runfusion/Fusion) ⭐ 1,136 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-19 - Multi-node orchestrator with a kanban board, plan-review-execute gates, per-task worktrees, and hierarchical missions.
...
* [Loop Engineering](https://github.com/cobusgreyling/loop-engineering) ⭐ 10,471 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-19 - Designs repeatable coding-agent loops around automation, worktrees, skills, state, and verification, with starters and a Loop Ready score for Grok, Claude Code, Codex, and OpenCode.
...
* [ralph-orchestrator](https://github.com/mikeyobrien/ralph-orchestrator) ⭐ 3,102 | 🐛 8 | 🌐 Rust | 📅 2026-08-16 - Hat-based orchestration that keeps agents looping until done, as a fuller implementation of the Ralph Wiggum technique.
...
* [bernstein](https://github.com/sipyourdrink-ltd/bernstein) ⭐ 932 | 🐛 215 | 🌐 Python | 📅 2026-08-19 - Keeps no model in the coordination loop, so orchestration costs zero tokens. Verifies with tests and auto-commits across 40+ CLI agents.
...
* [MartinLoop](https://github.com/Keesan12/martin-loop) ⭐ 44 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-19 - Caps spend, enforces policy, verifies output, and rolls back failures, leaving inspectable run receipts.
...
* [OpenHands](https://github.com/OpenHands/OpenHands) ⭐ 84,466 | 🐛 479 | 🌐 TypeScript | 📅 2026-08-19 - Self-hostable control center running its own agent or driving Claude Code, Codex, and any Agent Client Protocol agent, on schedules or webhooks.
* [multica](https://github.com/multica-ai/multica) ⭐ 46,810 | 🐛 1,373 | 🌐 Go | 📅 2026-08-19 - Managed agents platform where you assign tasks, track progress, and let agents compound skills between runs.
* [symphony](https://github.com/openai/symphony) ⭐ 26,754 | 🐛 9 | 🌐 Elixir | 📅 2026-08-12 - Turns project work into isolated autonomous runs, so teams manage the work rather than supervise the agent.
* [open-swe](https://github.com/langchain-ai/open-swe) ⭐ 10,576 | 🐛 28 | 🌐 Python | 📅 2026-08-19 - Invoked from Slack, Linear, or GitHub comments; each task runs in its own cloud sandbox and ends in a draft PR linked to the ticket.
* [claude-code-action](https://github.com/anthropics/claude-code-action) ⭐ 8,667 | 🐛 696 | 🌐 TypeScript | 📅 2026-08-19 - Anthropic's official GitHub Action, detecting from context whether to answer, review, or implement. Auth via Anthropic API, Bedrock, Vertex, or Foundry.
* [gh-aw](https://github.com/github/gh-aw) ⭐ 4,957 | 🐛 392 | 🌐 Go | 📅 2026-08-19 - Compiles agentic workflows written in Markdown into GitHub Actions YAML. Read-only by default, with writes only through sanitized safe-outputs. Copilot, Claude, Codex, Gemini.
* [background-agents](https://github.com/ColeMurray/background-agents) ⭐ 2,665 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-19 - Sessions trigger from a web UI, Slack, GitHub, Linear, webhooks, or cron, run in Modal, Daytona, Vercel, E2B, or OpenComputer sandboxes, and open attributed PRs.
...
* [centaur](https://github.com/paradigmxyz/centaur) ⭐ 1,151 | 🐛 48 | 🌐 Python | 📅 2026-08-19 - Multiplayer self-hosted agents with Slack-native conversations, Kubernetes sandboxes, shared tools, and durable workflows.
* [cyrus](https://github.com/cyrusagents/cyrus) ⭐ 774 | 🐛 96 | 🌐 TypeScript | 📅 2026-08-19 - Watches Linear, GitHub, GitLab, and Slack issues assigned to it, spinning up an isolated worktree per issue. Claude Code, Codex, Cursor, Gemini.
...
* [sortie](https://github.com/sortie-ai/sortie) ⭐ 127 | 🐛 51 | 🌐 Go | 📅 2026-08-19 - Turns tracker tickets into agent sessions. Agent-agnostic and tracker-agnostic, as a single Go binary with SQLite persistence.
...
* [Archon](https://github.com/coleam00/Archon) ⭐ 23,225 | 🐛 265 | 🌐 TypeScript | 📅 2026-08-19 - Harness builder for deterministic AI coding workflows, combining agent steps with scripts, validation gates, approvals, and isolated git worktrees. Claude Code, Codex, and more.
* [NemoClaw](https://github.com/NVIDIA/NemoClaw) ⭐ 22,199 | 🐛 349 | 🌐 TypeScript | 📅 2026-08-19 - Runs Hermes, LangChain Deep Agents, and OpenClaw inside NVIDIA OpenShell with managed inference.
* [openfang](https://github.com/RightNow-AI/openfang) ⭐ 18,122 | 🐛 115 | 🌐 Rust | 📅 2026-07-02 - Open-source agent operating system.
* [omnigent](https://github.com/omnigent-ai/omnigent) ⭐ 9,043 | 🐛 1,085 | 🌐 Python | 📅 2026-08-19 - Meta-harness running Claude Code, Codex, Cursor, OpenCode, Hermes, Pi, or custom YAML agents against swappable sandbox backends, with policy enforcement.
* [Open Multi-Agent](https://github.com/open-multi-agent/open-multi-agent) ⭐ 6,793 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-19 - TypeScript-native runtime where a coordinator turns a goal into a task DAG and a deterministic scheduler runs specialized agents, with approvals, traces, evaluation, checkpoints, and resume support.
...
* [Claudexor](https://github.com/razzant/claudexor) ⭐ 416 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-19 - Routes one coding thread across harnesses with quota-aware rotation between subscription profiles, Best-of-N runs, and cross-family review.
...
* [openclaw](https://github.com/openclaw/openclaw) ⭐ 386,761 | 🐛 5,779 | 🌐 TypeScript | 📅 2026-08-19 - Your own personal AI assistant, on any OS and any platform.
* [hermes-agent](https://github.com/NousResearch/hermes-agent) ⭐ 232,832 | 🐛 33,389 | 🌐 Python | 📅 2026-08-19 - Self-improving harness with persistent cross-session memory and auto-generated skill documents.
* [nanobot](https://github.com/HKUDS/nanobot) ⭐ 47,171 | 🐛 718 | 🌐 Python | 📅 2026-08-19 - Ultra-lightweight self-hosted assistant in Python with WebUI, tools, memory, MCP, and multi-agent workflows.
* [QwenPaw](https://github.com/agentscope-ai/QwenPaw) ⭐ 34,057 | 🐛 914 | 🌐 Python | 📅 2026-08-19 - Personal assistant that deploys to your own machine or the cloud and plugs into multiple chat apps. Formerly CoPaw.
* [zeroclaw](https://github.com/zeroclaw-labs/zeroclaw) ⭐ 32,617 | 🐛 746 | 🌐 Rust | 📅 2026-08-19 - Fast, small, fully autonomous assistant infrastructure in Rust, deployable anywhere.
* [nanoclaw](https://github.com/nanocoai/nanoclaw) ⭐ 30,550 | 🐛 906 | 🌐 TypeScript | 📅 2026-08-19 - Lightweight OpenClaw alternative running in containers, connecting to WhatsApp, Telegram, Slack, Discord, and Gmail.
* [picoclaw](https://github.com/sipeed/picoclaw) ⭐ 29,878 | 🐛 47 | 🌐 Go | 📅 2026-08-19 - Tiny and fast assistant deployable anywhere.
...
* [rowboat](https://github.com/rowboatlabs/rowboat) ⭐ 17,327 | 🐛 157 | 🌐 TypeScript | 📅 2026-08-19 - Open-source AI coworker with memory.
* [ironclaw](https://github.com/nearai/ironclaw) ⭐ 12,605 | 🐛 1,504 | 🌐 Rust | 📅 2026-08-19 - Agent OS in Rust focused on privacy, security, and extensibility.
...
* [Cloudflare OS](https://github.com/cloudflare/cloudflare-os) ⭐ 8,596 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-19 - Self-hostable "company OS" on Cloudflare Workers: a chat UI where agents preloaded with your company context do tasks, build sandboxed apps, and stay inside a Gatekeepers guardrail framework.
...
* [lobsterai](https://github.com/netease-youdao/LobsterAI) ⭐ 5,920 | 🐛 686 | 🌐 TypeScript | 📅 2026-08-19 - Desktop-grade agent for data analysis, slides, docs, and web research.
...
* [Ouroboros](https://github.com/razzant/ouroboros) ⭐ 1,192 | 🐛 95 | 🌐 Python | 📅 2026-08-19 - General-purpose agent with durable identity and memory, reviewed self-modification, multi-agent coordination, and desktop and headless interfaces.
...
* [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 45 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-19 - Self-hosted team of specialized agents with persistent memory that delegate and build their own tools and mini-apps. Telegram, Slack, Discord, Matrix. Single container, MIT.
...
* [vibe-kanban](https://github.com/BloopAI/vibe-kanban) ⭐ 27,848 | 🐛 534 | 🌐 Rust | 📅 2026-04-24 - Kanban board for managing AI coding agents. *(last commit 2026-04)*
